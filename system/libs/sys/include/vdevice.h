...
typedef struct {
	...
	int (*read_block)(int fd, int from_pid, fsinfo_t* info, void* buf, int size, int index, void* p);
	int (*write_block)(int fd, int from_pid, fsinfo_t* info, const void* buf, int size, int index, void* p);
